...
/**
 * An activity representing a single Servicios detail screen. This
 * activity is only used on narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link ServiciosListActivity}.
 */
public class ServiciosDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(ServiciosDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(ServiciosDetailFragment.ARG_ITEM_ID));
