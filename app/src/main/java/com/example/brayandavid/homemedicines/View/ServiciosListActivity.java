...
import com.example.brayandavid.homemedicines.Conection.HttpConection;
import com.example.brayandavid.homemedicines.R;

import java.util.ArrayList;
import java.util.List;

public class ServiciosListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HttpConection task = new HttpConection(this);
        try {
            List<Producto> productos = task.execute().get();
            recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter(this, productos, mTwoPane));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public class SimpleItemRecyclerViewAdapter
        ...
        private final ServiciosListActivity mParentActivity;
            ...
            mOnClickListener = new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (mTwoPane) {
                        ...
                        arguments.putSerializable(ServiciosDetailFragment.ARG_ITEM_ID, item);
                        ...
                        Intent intent = new Intent(context, ServiciosDetailActivity.class);
                        intent.putExtra(ServiciosDetailFragment.ARG_ITEM_ID, item);
        ...
        SimpleItemRecyclerViewAdapter(ServiciosListActivity parent,
                                      List<Producto> items,
                                      boolean twoPane) {
            mValues = items;
    ...
    public List<Producto> getProductxxx() {
